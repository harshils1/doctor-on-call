...
export default function ViewRequestPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const patientSnapshot = await getDoc(doc(db, "users", fetchedRequest.requestingUser));
            const fetchedPatient = patientSnapshot.data();
            setPatient(fetchedPatient);

            if (fetchedRequest.acceptingDoctorUid) {
                const accDocSnapshot = await getDoc(doc(db, "users", fetchedRequest.acceptingDoctorUid));
