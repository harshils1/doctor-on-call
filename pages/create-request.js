...
import { getDoc, doc, getDocs, query, collection, where, addDoc } from 'firebase/firestore';
    ...
    return (
        ...
        <Stack spacing={8} mx={'auto'} maxW={'lg'} py={12} px={6}>
            ...
            <Stack spacing={4}>
                ...
                <FormLabel>Message (Include symptoms, relevant medical history, any important details)</FormLabel>
                <Textarea rows={10} name="message" onChange={handleFormChange}/>
                </FormControl>

                <Stack>
                    <FormControl id="doctors">
                    <FormLabel>Doctors available in {user?.city}, {user?.state}, {user?.country}</FormLabel>
